LOCALIZATIONS.en = {
    ...
    "byElement":{
        "title":"Send STEEM/SBD with escrow"
    },
    "byId":{
        ...
        "labelAgent":"Choose the escrow agent. To become an agent, post a comment <a href=\"https://steemit.com/test/@xtar/escrow-agents-homepage\">here</a> (sorted by agent reputation).",
        "selectOptionChooseAgent":"Choose an agent from the list",
        "labelSendFeeAmout":"Fee by",
        "inputSendAmount":"Amount, click to toggle units",
        "labelDeadline":"Specify the period within which the recipient and the escrow must agree to commit the transaction. If they don't approve the transaction before the deadline, the funds will be automatically returned to the sender:",
        "labelEscrowEndDate":"Specify the warranty expiration period after which either party can take any action (either take the money or send the other party). This period cannot be less than the previous one:",
